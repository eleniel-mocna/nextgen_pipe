...
threads_folder="/mnt/storage/clip/Samuel_workdir/nextgen_pipe/scripts/multi_threading"
...
docker build -t ngs_main_samuel Dockerfiles/main
...
docker build -t varscan_samuel Dockerfiles/varScan
...
docker build -t star_samuel Dockerfiles/starAligner
...
docker build -t rocker_1dna2p_samuel Dockerfiles/rocker-stuff
...
docker build -t python_1dna2p_samuel Dockerfiles/python-stuff
...
docker build -t cvc_eleniel Dockerfiles/CustomVariantCaller
